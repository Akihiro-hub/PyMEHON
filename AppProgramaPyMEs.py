...
rubro = st.sidebar.selectbox("Herramientas de planificación a aplicar", ["Seleccione", "Plan de negocio en operación",  "Pronóstico de ventas", "Simulación de inversión", "Planificación de inventario", "Planificación de venta (Comedor)"])
...
if rubro == "Seleccione":
    ...
    # 過去12か月の売上データの初期値
    ventas_iniciales = [59000, 53000, 62000, 75000, 69000, 58000, 71000, 74000, 64000, 65000, 66000, 67000]
